...
export function createCityTile(
  ...
  const tile = {
    ...
    records,
    signals,
    role: /** @type {import('../core/types.js').TileRole} */ ('next'),
    reveal: 1,
    warmth: 0.2,
    disposed: false,
    signal: /** @type {import('../core/types.js').TrafficSignalState} */ ('red'),
    crossSignal: /** @type {import('../core/types.js').TrafficSignalState} */ ('green'),
  };
